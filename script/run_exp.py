...
def main():
    ...
    if (cfg.MODEL.NAME == "timesformer_udiva" and cfg.DATA_LOADER.TRAIN_BATCH_SIZE >= 16 and cfg.DATA.SAMPLE_SIZE > 16) or cfg.MODEL.NAME == "visual_graph_representation_learning":
