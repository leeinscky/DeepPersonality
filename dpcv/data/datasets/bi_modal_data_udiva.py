...
class VideoDataUdiva(Dataset):
    ...
    def __init__(self, data_root, img_dir, label_file, audio_dir=None, parse_img_dir=True, parse_aud_dir=False):
        # print('[DeepPersonality/dpcv/data/datasets/bi_modal_data_udiva.py] - 开始执行 def __init__')
    ...
    def parse_annotation(self, label_file):
        ...
        # print('[DeepPersonality/dpcv/data/datasets/bi_modal_data_udiva.py]parse_annotation函数 - annotation: ', annotation)
        return annotation
    ...
    def get_ocean_label(self, index): 
        ...
        # print('[DeepPersonality/dpcv/data/datasets/bi_modal_data_udiva.py]get_ocean_label函数 - 开始执行 def get_ocean_label, session_id: ', session_id, 'type: ', type(session_id)) #  session_id:  
        # print('[DeepPersonality/dpcv/data/datasets/bi_modal_data_udiva.py]get_ocean_label函数 - 开始执行 def get_ocean_label, self.annotation: ', self.annotation, 'type: ', type(self.annotation)) #  self.annotation:  
       
        # get the type of self.annotation[session_id]
        # print('[DeepPersonality/dpcv/data/datasets/bi_modal_data_udiva.py]get_ocean_label函数 - 开始执行 def get_ocean_label, self.annotation[session_id]: ', self.annotation[session_id], 'type of self.annotation[session_id]: ', type(self.annotation[session_id])) #  self.annotation[session_id]:
        # conver the type of self.annotation[session_id] to list
        self.annotation[session_id] = list(self.annotation[session_id])
        # print('[DeepPersonality/dpcv/data/datasets/bi_modal_data_udiva.py]get_ocean_label函数 - 开始执行 def get_ocean_label, self.annotation[session_id]: ', self.annotation[session_id], 'type of self.annotation[session_id]: ', type(self.annotation[session_id])) #  self.annotation[session_id]:
        
        relation = self.annotation[session_id]
        # print('[DeepPersonality/dpcv/data/datasets/bi_modal_data_udiva.py]get_ocean_label函数 - 开始执行 def get_ocean_label, relation: ', relation)
        return relation
