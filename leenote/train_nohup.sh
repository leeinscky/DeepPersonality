...
# --bs $batch_size \
# --lr $learning_rate \
# >nohup_log/nohup_full_resnet3D_samp${sample_size}_epo${epoch}_bs${batch_size}_lr${learning_rate}_`date +'%m-%d-%H:%M:%S'`.log 2>&1 &
...
# --bs $batch_size \
# --lr $learning_rate \
# >nohup_full_cfg2_samp${sample_size}_epo${epoch}_bs${batch_size}_lr${learning_rate}_`date +'%m-%d-%H:%M:%S'`.log 2>&1 &
