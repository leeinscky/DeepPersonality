...
def process_noxi_dataset():
    ...
    for recordings_dir in recordings_dir_list:
        ...
        for task_dir in os.scandir(recordings_dir):
            ...
            if task_dir.name == 'img':
                task_dir_img = task_dir
                # print('task_dir_img: ', task_dir_img) # task_dir_img:   <DirEntry 'img'>
                
                # wav目录的名称
                task_dir_wav = "wav"
                task_dir_wav_full_path = os.path.join(recordings_dir, task_dir_wav)
                # print('task_dir_wav_full_path: ', task_dir_wav_full_path) #  task_dir_wav_full_path: .../datasets/noxi/wav
...
if  __name__   ==   '__main__' :
    # process_udiva_dataset()
    process_noxi_dataset()
